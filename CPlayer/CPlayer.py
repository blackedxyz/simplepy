import os,sys,ctypes,winreg,chardet,platform
...
if __name__=='__main__':
    ...
    idirCPlayerpy=os.path.abspath('CPlayer.py')
    idirCPlayerexe=os.path.abspath('CPlayer.exe')
    try:
        fp=sys.argv[1]
    except:
        fp=None
    if ctypes.windll.shell32.IsUserAnAdmin():
        ...
        if os.path.exists(r'CPlayer.py'):
            command=r'"%s" "%s"'%(pythonpath,idirCPlayerpy)
        else:
            command=r'"%s"'%idirCPlayerexe
